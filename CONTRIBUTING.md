<a name="readme-top"></a>
# Contributing To LibraryServiceStatusSystemService

Though LibraryServiceStatusSystemService is developed and maintained by Texas A&M University Libraries, we welcome community contributions.
Involvement in LibraryServiceStatusSystemService can take many forms:

<div align="right">(<a href="#readme-top">back to top</a>)</div>

## Using

Deploying LibraryServiceStatusSystemService and trying it out at your own institution is itself a way of contributing to the development process.
...
Once you are using LibraryServiceStatusSystemService the creation of new issues through GitHub is a major method of contribution towards LibraryServiceStatusSystemService development.
...
Each *PR* will need to be reviewed by a LibraryServiceStatusSystemService developer.
...
If you have any additional questions please contact the LibraryServiceStatusSystemService developers at [helpdesk@library.tamu.edu][helpdesk-email].
